...
public partial class ACCOUNTING_LTTContext : DbContext
{
    public ACCOUNTING_LTTContext()
    {
    }

    public ACCOUNTING_LTTContext(DbContextOptions<ACCOUNTING_LTTContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer(ConfigurationManager.ConnectionStrings["ACCOUNTING_LTTContext"].ConnectionString);
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HrDayOff>(entity =>
        {
            ...
            entity.Property(e => e.TimeOffEnd).HasMaxLength(6);
            entity.Property(e => e.UpdatedBy).HasMaxLength(50);
            entity.Property(e => e.UpdatedDate)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<HrOverTime>(entity =>
        {
            ...
            entity.Property(e => e.OverTimeDay)
                ...
                .HasMaxLength(8)
                .HasComment("Ngày trong tháng");
            entity.Property(e => e.OverTimeEnd).HasMaxLength(6);
        ...
        modelBuilder.Entity<HrTimeSheet>(entity =>
        {
            ...
            entity.Property(e => e.TimeOut).HasMaxLength(6);
            entity.Property(e => e.TimeOutOvertime).HasMaxLength(6);
            entity.Property(e => e.UpdatedBy).HasMaxLength(50);
            entity.Property(e => e.UpdatedDate)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
        ...
        {
            entity.HasKey(e => new { e.CustomerId, e.ScheduleValue }).HasName("PK_OrderConditionSchedule_1");
            ...
            entity.Property(e => e.OrderValues)
                .IsRequired()
                .HasMaxLength(400);
            entity.Property(e => e.ScheduleType)
                .HasMaxLength(1)
        ...
        modelBuilder.Entity<SysParamValue>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasTrigger("SysParamValues_Date"));
        ...
        modelBuilder.Entity<TransDetail>(entity =>
        {
            ...
            entity.ToTable("TransDetail", tb => tb.HasTrigger("Transactions_inventory"));
