...
{
    public partial class AccountingBusinessGetRetailTranDetailByPacketResult
    {
        ...
        [Column("ExpPrice", TypeName = "decimal(38,8)")]
        public decimal? ExpPrice { get; set; }
        [Column("ExpPriceVAT", TypeName = "decimal(38,8)")]
        public decimal? ExpPriceVAT { get; set; }
        [Column("ExpPrice2", TypeName = "decimal(1,1)")]
        public decimal ExpPrice2 { get; set; }
        [Column("ExpPriceVat2", TypeName = "decimal(1,1)")]
        public decimal ExpPriceVat2 { get; set; }
        [Column("ExpPrice_CK", TypeName = "decimal(38,8)")]
        public decimal? ExpPrice_CK { get; set; }
        [Column("ExpPriceVAT_CK", TypeName = "decimal(38,8)")]
        public decimal? ExpPriceVAT_CK { get; set; }
        [Column("DiscountAmount", TypeName = "decimal(38,8)")]
        ...
        [Column("VatPercent", TypeName = "decimal(1,1)")]
        ...
        [Column("PriceOrg", TypeName = "decimal(38,8)")]
        public decimal? PriceOrg { get; set; }
        [Column("PriceVATOrg", TypeName = "decimal(38,8)")]
        ...
        [Column("ImpPrice", TypeName = "decimal(1,1)")]
        public decimal ImpPrice { get; set; }
        [Column("ImpPriceVAT", TypeName = "decimal(1,1)")]
