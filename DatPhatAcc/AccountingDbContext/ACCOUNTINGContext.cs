...
public partial class ACCOUNTINGContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AlertDate>(entity =>
        {
            ...
            entity.Property(e => e.NoOfDate).HasDefaultValue(0);
            entity.Property(e => e.SynStatus)
                .HasMaxLength(1)
                .IsFixedLength();
            entity.Property(e => e.SyncTime)
        ...
        modelBuilder.Entity<CheckStatistic>(entity =>
        {
            ...
            entity.Property(e => e.TransactionId)
                .HasMaxLength(20)
                .HasColumnName("TransactionID");
            entity.Property(e => e.AllowTran).HasDefaultValue(false);
            entity.Property(e => e.Condition).HasMaxLength(4000);
            entity.Property(e => e.CreatedBy).HasMaxLength(50);
            entity.Property(e => e.CreatedDate)
                .HasDefaultValueSql("(getdate())")
        ...
        modelBuilder.Entity<Contract>(entity =>
        {
            ...
            entity.Property(e => e.CustomerId)
                ...
                .HasMaxLength(20)
                .HasColumnName("CustomerID");
            entity.Property(e => e.EnableSchedule).HasDefaultValue(false);
        ...
        modelBuilder.Entity<ContractTermsOfPayment>(entity =>
        {
            ...
            entity.Property(e => e.PaymentPercentage).HasDefaultValue(100);
            entity.Property(e => e.SyncTime)
                .HasMaxLength(14)
                .HasDefaultValueSql("([dbo].[GetStringSyncTime]())");
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.Property(e => e.DebtDay).HasDefaultValue(0);
        ...
        modelBuilder.Entity<Good>(entity =>
        {
            ...
            entity.Property(e => e.GroupId)
                .HasMaxLength(6)
                .HasColumnName("GroupID");
            entity.Property(e => e.HasExpireDate).HasDefaultValue(false);
            entity.Property(e => e.HasSerial).HasDefaultValue(false);
            ...
            entity.Property(e => e.Note).HasMaxLength(200);
            entity.Property(e => e.NumberExpireDay).HasDefaultValue(0);
            entity.Property(e => e.NumberWarrantyDay).HasDefaultValue(0);
            ...
            entity.Property(e => e.UpdatedDate)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.Warranty).HasDefaultValue(false);
        ...
        {
            entity.HasKey(e => new { e.ZoneId, e.GoodId, e.CreatedDate, e.SyncTime });
        ...
        modelBuilder.Entity<HrDepartment>(entity =>
        {
            ...
            entity.Property(e => e.SalaryProfitRate)
                .HasDefaultValue(0m)
                .HasColumnType("decimal(22, 8)");
            entity.Property(e => e.SalarySaleByWorkday).HasDefaultValue(true);
        ...
        modelBuilder.Entity<HrOverTime>(entity =>
        {
            ...
            entity.Property(e => e.CustomerId)
                ...
                .HasMaxLength(10)
                .HasColumnName("CustomerID");
            entity.Property(e => e.DepartmentIdApply)
                .IsRequired()
                .HasMaxLength(50);
            entity.Property(e => e.Note).HasMaxLength(200);
        ...
        modelBuilder.Entity<HrTimeSheet>(entity =>
        {
            ...
            entity.Property(e => e.TimekeepingDate)
                .HasMaxLength(8)
                .HasComment("Ngày trong tháng");
            entity.Property(e => e.CheckForSalary).HasDefaultValue(true);
            entity.Property(e => e.CreatedBy).HasMaxLength(50);
            entity.Property(e => e.CreatedDate)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<NegTransDetail>(entity =>
        {
            ...
            entity.Property(e => e.LotNumber)
                ...
                .HasDefaultValue("")
                .HasComment("Số Lô");
            entity.Property(e => e.NegativeQuatity).HasDefaultValue(0);
            ...
            entity.Property(e => e.OrginalQty).HasDefaultValue(0);
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.Property(e => e.DiscountAmount)
                .HasDefaultValue(0m)
                .HasColumnType("decimal(22, 8)");
            entity.Property(e => e.DiscountRate).HasDefaultValue(0);
            entity.Property(e => e.ExchangeRate).HasColumnType("decimal(22, 8)");
            entity.Property(e => e.GroupId)
                .HasMaxLength(6)
                .HasColumnName("GroupID");
        ...
        modelBuilder.Entity<QtyMinMaxDetail>(entity =>
        {
            ...
            entity.Property(e => e.QtyMax).HasDefaultValue(0);
            entity.Property(e => e.QtyMin).HasDefaultValue(0);
        ...
        modelBuilder.Entity<SysParam>(entity =>
        {
            ...
            entity.Property(e => e.SysParamType).HasDefaultValue(1);
            entity.Property(e => e.UpdatedBy).HasMaxLength(20);
            entity.Property(e => e.UpdatedDate)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<TransactionObjectRelate>(entity =>
        {
            ...
            entity.Property(e => e.OrderColunm).HasDefaultValue(1);
        ...
        modelBuilder.Entity<VoucherDefine>(entity =>
        {
            ...
            entity.Property(e => e.ItemId)
                .ValueGeneratedOnAdd()
                .HasColumnName("ItemID");
            entity.Property(e => e.LengthOfValue).HasDefaultValue(5);
